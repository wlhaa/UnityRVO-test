...
namespace RVO
{
    ...
    public class Simulator
    {
        ...
        private Dictionary<int, float> estimatedSpeeds = new Dictionary<int, float>();

        public void setEstimatedSpeed(int agentNo, float speed)
        {
            estimatedSpeeds[agentNo] = speed;
        }

        public float getEstimatedSpeed(int agentNo)
        {
            return estimatedSpeeds.ContainsKey(agentNo) ? estimatedSpeeds[agentNo] : 0.0f;
        }
        /**
